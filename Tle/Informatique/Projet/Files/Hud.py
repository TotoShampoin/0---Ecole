...
watch = pygame.image.load("Graphics/Watch.png").convert_alpha()
conte = pygame.image.load("Graphics/Chest.png").convert_alpha()
pause = pygame.image.load("Graphics/Pause.png").convert_alpha()
